---
title: "GDP PPP for different countries over time!"
filters:
  - shinylive
---
<!-- Empty line --> <br>
GDP (PPP) means gross domestic product based on purchasing power parity. Here you can further read about [GDP PPP](https://en.wikipedia.org/wiki/List_of_countries_by_GDP_(PPP)).
```{r, echo=FALSE}
shiny::tags$div(
  style = "border: 2px solid black; padding: 10px;", 
  shiny::tags$iframe(style="height:400px; width:100%;", src="https://en.wikipedia.org/wiki/List_of_countries_by_GDP_(PPP)")
)
```

<!-- Empty line --> <br>
Here you can see the GDP PPP for different countries over time. You can select the countries and the years you want to see the data for. The data is from the World Bank.
```{shinylive-r}
#| standalone: true
#| viewerHeight: 400
library(shiny)
